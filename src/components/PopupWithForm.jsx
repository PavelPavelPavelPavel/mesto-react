function PopupWithForm(props) {
  return (
    <>
      ...
      <div class="popup popup_edit_avatar">
        <div class="popup__container">
          ...
          ></button>
          <div class="popup__form popup__form_edit_avatar">
            <h2 class="popup__title">Обновить аватар</h2>
            <form
              name="avatar"
              class="popup__input-wrapper popup__input-avatar"
              novalidate
            >
              <input
                id="input-url-avatar"
              ...
              <button
                type="submit"
                class="popup__button popup__button-avatar popup__button_disabled"
                disabled
              >
                Сохранить
              </button>
